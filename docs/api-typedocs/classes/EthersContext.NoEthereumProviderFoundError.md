[eth-hooks - v4.0.25](../README.md) / [EthersContext](../modules/EthersContext.md) / NoEthereumProviderFoundError
...
[src/context/ethers/connectors/connectorErrors.ts:27](https://github.com/scaffold-eth/eth-hooks/blob/75acc7e/src/context/ethers/connectors/connectorErrors.ts#L27)
