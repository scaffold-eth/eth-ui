...
After setup, we'll get an account balance on the Ethereum blockchain and show it on our frontend (_pretty cool stuff!_)
...
Here's how we'll set up the static provider from the [scaffold-eth](https://github.com/scaffold-eth/scaffold-eth) RPC.
