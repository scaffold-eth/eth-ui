...
| `GAppConnectorList` | extends [`TConnectorList`](Models.md#tconnectorlist-2)<`GContractNames`, [`TBaseContractExtended`](Models.md#tbasecontractextended-2)<`GContractNames`\>\> | A type are the list of contracts and their connectors. Should be `ReturnType<loadAppContractConnectors>`, where `loadAppContractConnectors` is the function that returns the contract connectors config.                      |
